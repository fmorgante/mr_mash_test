...
```{r fit mr.mash fixed V, results='hide'}
###Fit mr.mash
...
```{r fit mr.mash init V, results='hide'}
###Fit mr.mash
...
```{r fit mr.mash diag V, results='hide'}
###Fit mr.mash
...
```{r fit mr.mash diag V init w0, results='hide'}
###Fit mr.mash
...
```{r fit mr.mash diag V true w0, results='hide'}
###Fit mr.mash
...
```{r fit mr.mash true V true w0, results='hide'}
###Fit mr.mash
...
```{r 50 causal variables analysis, results='hide'}
###Set parameters
n <- 1000
p <- 1000
p_causal <- 50
...
```{r 500 causal variables analysis, results='hide'}
###Set parameters
n <- 1000
p <- 500
p_causal <- 250
