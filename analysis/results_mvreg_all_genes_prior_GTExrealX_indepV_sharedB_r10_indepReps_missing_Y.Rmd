---
title: "Simulations with GTEx genotypes and shared effects -- independent replicates and missing values in Y"
...
for(repl in 1:20){
  ...
  dsc_out <- dscquery(paste0("output/mvreg_all_genes_prior_GTExrealX_indepV_sharedB_r10_indepReps_missing_Y/rep", repl), 
