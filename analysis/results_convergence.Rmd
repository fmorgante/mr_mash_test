...
mr.mash was fitted to the training data (`r (1-prop_testset3)*100`% of the data) updating V and updating the prior weights using mixSQP.

Here, we investigate convergence.

```{r conv 3, fig.height=12, fig.width=15}
