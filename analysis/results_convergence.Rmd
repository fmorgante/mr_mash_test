...
plot(progress_dat1$iter, progress_dat1$mu1_max.diff, xlab="Iteration", ylab="log Difference in max(mu1)", main="mu1 vs iteration", type="b", pch=16, cex.lab=1.5, cex.axis=1.5, log="y")
```
...
plot(progress_dat2$iter, progress_dat2$mu1_max.diff, xlab="Iteration", ylab="log Difference in max(mu1)", main="mu1 vs iteration", type="b", pch=16, cex.lab=1.5, cex.axis=1.5, log="y")
```
...
plot(progress_dat3$iter, progress_dat3$mu1_max.diff, xlab="Iteration", ylab="log Difference in max(mu1)", main="mu1 vs iteration", type="b", pch=16, cex.lab=1.5, cex.axis=1.5, log="y")
```
...
plot(progress_dat4$iter, progress_dat4$mu1_max.diff, xlab="Iteration", ylab="log Difference in max(mu1)", main="mu1 vs iteration", type="b", pch=16, cex.lab=1.5, cex.axis=1.5, log="y")
```
