---
title: "Simulations with GTEx genotypes and 1 causal response -- independent replicates"
...
4. We fitted competing methods and *mr.mash* to the training set for the first gene. *mr.mash* was fitted updating V (imposing a diagonal structure) and updating the prior weights using EM updates. The mixture prior consisted of components defined by:
