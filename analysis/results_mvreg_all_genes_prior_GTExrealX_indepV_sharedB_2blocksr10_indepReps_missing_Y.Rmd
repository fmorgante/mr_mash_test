---
title: "Simulations with GTEx genotypes and effect structure similar to GTEx gene expression -- independent replicates and missing values in Y"
...
for(repl in 1:20){
  ...
  dsc_out <- dscquery(paste0("output/mvreg_all_genes_prior_GTExrealX_indepV_sharedB_2blocksr10_diffPVE_indepReps_missing_Y/rep", repl), 
