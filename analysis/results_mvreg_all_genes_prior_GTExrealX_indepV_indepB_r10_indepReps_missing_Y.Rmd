...
for(repl in 1:20){
  ...
  dsc_out <- dscquery(paste0("output/mvreg_all_genes_prior_GTExrealX_indepV_indepB_r10_indepReps_missing_Y/rep", repl), 
                      ...
                      groups="fit: mr_mash_em_can, mr_mash_em_data, mr_mash_em_dataAndcan, mr_mash_em_dataAndcan_dropcomp, mtlasso, enet",
                      verbose=FALSE)
...
dsc_plots$method_fac <- factor(dsc_plots$method, levels=c("mr_mash_em_can", "mr_mash_em_data",
                                                ...
                                                labels=c("mr_mash_can", "mr_mash_data", "mr_mash_both", 
                                                         "mr_mash_both_drop", "mtlasso", "enet"))
