---
title: "Simulations with GTEx genotypes and independent effects -- independent replicates and missing values in Y"
...
for(repl in 1:20){
  ...
  dsc_out <- dscquery(paste0("output/mvreg_all_genes_prior_GTExrealX_indepV_indepB_r10_indepReps_missing_Y/rep", repl), 
...
###Create plots
p_rrmse <- ggplot(dsc_plots[which(dsc_plots$score_metric=="scaled_rrmse"), ], aes_string(x = "method_fac", y = "score_value", fill = "method_fac")) +
  geom_boxplot(color = "black", outlier.size = 1, width = 0.85) +
  scale_fill_manual(values = colors) +
  labs(x = "", y = "Error", title = "rRMSE", fill="Method") +
  geom_hline(yintercept=1, linetype="dotted", size=1) +
  theme_cowplot(font_size = 20) +
  theme(plot.title = element_text(hjust = 0.5), axis.line.x = element_blank(), axis.text.x = element_blank(), axis.ticks.x = element_blank())
...
p_rrmse_noout <- ggplot(dsc_plots[which(dsc_plots$score_metric=="scaled_rrmse"), ], aes_string(x = "method_fac", y = "score_value", fill = "method_fac")) +
