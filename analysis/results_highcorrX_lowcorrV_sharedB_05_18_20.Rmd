---
title: "Highly correlated predictors, shared effects, lowly correlated residuals"
...
dsc_out <- dscquery("output/dsc_05_18_20", c("simulate.n", "simulate.p", "simulate.p_causal", "simulate.r",   
                    ...
                    conditions = "$(simulate) == 'highcorrX_lowcorrV_sharedB' & $(simulate.p_causal) == 50", verbose=FALSE,
...
dsc_out <- dscquery("output/dsc_05_18_20", c("simulate.n", "simulate.p", "simulate.p_causal", "simulate.r",   
                                 ...
                                 "simulate.V_cor", "simulate.prop_testset",
                                 "simulate", "fit", "score", "score.err", "fit.time"), 
                    conditions = "$(simulate) == 'highcorrX_lowcorrV_sharedB' & $(simulate.p_causal) == 500", verbose=FALSE,
                    ignore.missing.files = TRUE )
