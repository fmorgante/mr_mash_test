---
title: "Simulations with GTEx genotypes and independent effects -- independent replicates"
...
for(repl in 1:20){
  ...
  dsc_out <- dscquery(paste0("output/mvreg_all_genes_prior_GTExrealX_indepV_indepB_r10_indepReps/rep", repl), 
