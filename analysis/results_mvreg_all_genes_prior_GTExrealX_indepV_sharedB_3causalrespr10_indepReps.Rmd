---
title: "Simulations with GTEx genotypes and 3 causal responses with shared effects -- independent replicates"
...
for(repl in c(1:13, 15:20)){
  ###Load the dsc results
  dsc_out <- dscquery(paste0("output/mvreg_all_genes_prior_GTExrealX_indepV_sharedB_3causalrespr10_indepReps/rep", repl), 
