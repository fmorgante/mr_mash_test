...
###Plot bias
p_bias <- ggplot(dsc_plots[which(dsc_plots$score_metric=="bias"), ], aes_string(x = "response_fac", y = "score_value", fill = "method")) +
  geom_boxplot(color = "black", outlier.size = 1, width = 0.85) +
  #geom_boxplot2(width.errorbar = 0, width = 0.85) +
...
###Plot r2
p_r2 <- ggplot(dsc_plots[which(dsc_plots$score_metric=="r2"), ], aes_string(x = "response_fac", y = "score_value", fill = "method")) +
  geom_boxplot(color = "black", outlier.size = 1, width = 0.85) +
  #geom_boxplot2(width.errorbar = 0, width = 0.85) +
  scale_fill_manual(values = colors) +
...
###Plot rrmse
p_rrmse <- ggplot(dsc_plots[which(dsc_plots$score_metric=="rrmse"), ], aes_string(x = "response_fac", y = "score_value", fill = "method")) +
  geom_boxplot(color = "black", outlier.size = 1, width = 0.85) +
  #geom_boxplot2(width.errorbar = 0, width = 0.85) +
  scale_fill_manual(values = colors) +
