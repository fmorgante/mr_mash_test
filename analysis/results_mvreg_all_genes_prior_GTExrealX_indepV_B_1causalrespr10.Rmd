...
dsc_out <- dscquery("/project2/mstephens/fmorgante/mr_mash_test/output/mvreg_all_genes_prior_GTExrealX_indepV_B_1causalrespr10", 
...
* both canonical and data-driven matrices plus the spike, dropping components with $w0 < 1e-8$.
