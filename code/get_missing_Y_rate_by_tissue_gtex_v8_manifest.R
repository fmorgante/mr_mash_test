...
gtex_missing_rate <- cbind(Gene_Name=gene_names, res)

###Write out results
write.table(gtex_missing_rate, "../data/gtex-v8-missing-rate-by-tissue.txt", sep="\t", row.names = FALSE, col.names=FALSE, quote=FALSE)
