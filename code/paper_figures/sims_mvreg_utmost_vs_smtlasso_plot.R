...
dsc_plots_1causalresp <- readRDS("../../output/sims_paper_figures_inter/mvreg_indepX_indepV_B_1causalr_utmost_smtlasso_for_plotting.rds")
dsc_plots_indep <- readRDS("../../output/sims_paper_figures_inter/mvreg_indepX_indepV_indepB_allr_norm_utmost_smtlasso_for_plotting.rds")
dsc_plots_shared <- readRDS("../../output/sims_paper_figures_inter/mvreg_indepX_indepV_sharedB_allr_norm_utmost_smtlasso_for_plotting.rds")
dsc_plots_2blocks <- readRDS("../../output/sims_paper_figures_inter/mvreg_indepX_indepV_sharedB_2blocksr_diffPVE_utmost_smtlasso_for_plotting.rds")
dsc_plots_3causalresp <- readRDS("../../output/sims_paper_figures_inter/mvreg_indepX_indepV_sharedB_3causalrespr10_utmost_smtlasso_for_plotting.rds")
...
###Error
##Create plot
methods_chosen <- c("mtlasso", "utmost")
metric_chosen <- "scaled_rmse"
...
#  ylim(ymin, ymax) +
  scale_fill_manual(values = colors[c(7,11)], labels = c("smt-lasso", "utmost")) +
  labs(x = "Tissue", y = "RMSE", title = "Mostly null", fill="Method") +
...
#  ylim(ymin, ymax) +
  scale_fill_manual(values = colors[c(7,11)], labels = c("smt-lasso", "utmost")) +
  labs(x = "Tissue", y = "RMSE", title = "Independent effects", fill="Method") +
  theme_cowplot(font_size = 16) +
  theme(plot.title = element_text(hjust = 0.5, size=14), legend.position="none")
...
#  ylim(ymin, ymax) +
  scale_fill_manual(values = colors[c(7,11)], labels = c("smt-lasso", "utmost")) +
  labs(x = "Tissue", y = "RMSE", title = "Equal effects", fill="Method") +
  theme_cowplot(font_size = 16) +
  theme(plot.title = element_text(hjust = 0.5, size=14), legend.position="none")
...
#  ylim(ymin, ymax) +
  scale_fill_manual(values = colors[c(7,11)], labels = c("smt-lasso", "utmost")) +
  labs(x = "Tissue", y = "RMSE", title = "Shared effects in subgroups", fill="Method") +
  theme_cowplot(font_size = 16) +
...
#  ylim(ymin, ymax) +
  scale_fill_manual(values = colors[c(7,11)], labels = c("smt-lasso", "utmost")) +
  labs(x = "Tissue", y = "RMSE", title = "Equal effects +  null", fill="Method") +
  theme_cowplot(font_size = 16) +
  theme(plot.title = element_text(hjust = 0.5, size=14), legend.position="none")
...
ggsave("../../analysis/paper_figures/mvreg_smtlasso_vs_utmost_rmse.pdf", plot=p_methods_all, device="pdf", units="in", height=8, width=11)
...
ggsave("../../analysis/paper_figures/mvreg_smtlasso_vs_utmost_runtime.pdf", plot=p_methods_time_all, device="pdf", units="in", height=8, width=11)
