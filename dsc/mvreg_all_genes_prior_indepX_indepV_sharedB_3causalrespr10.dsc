...
DSC:
  ...
  exec_path: modules
  define:
    simulate: indepX_indepV_sharedB_subsetcausalr
...
indepX_indepV_sharedB_subsetcausalr: simulate_data_all_genes_prior_mod.R
  n:              900
  p:              5000
  p_causal:       5
  r:              10
  ...
  X_scale:        1
  V_cor:          0
  testset_index:  "../output/mvreg_all_genes_prior_indepX_indepV_sharedB_3causalrespr10_inter/misc/testset_indeces.rds"
  $Xtrain: out$Xtrain
  $Ytrain: out$Ytrain
  $Xtest:  out$Xtest
  $Ytest:  out$Ytest
...
mr_mash_em_data(mr_mash_em_can):
  ...
  data_driven_mats:       "/project2/mstephens/fmorgante/mr_mash_test/output/mvreg_all_genes_prior_indepX_indepV_sharedB_3causalrespr10_inter/prior/matrices/mvreg_all_genes_prior_indepX_indepV_sharedB_3causalrespr10.EZ.FL_PC3.rds"
