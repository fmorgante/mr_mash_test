...
indepV_B_1causalr: simulate_data_all_genes_prior_gtex_mod.R
  X:              $X
  p_causal:       5
  r:              10
  r_causal:       raw(list(1))
  ...
  pve:            0.05
  V_cor:          0
  testset_index:  "../output/mvreg_all_genes_prior_GTExrealX_indepV_B_1causalrespr10_lowPVE_inter/misc/testset_ids.rds"
  $Xtrain: out$Xtrain
  $Ytrain: out$Ytrain
  $Xtest:  out$Xtest
  $Ytest:  out$Ytest
...
mr_mash_em_data(mr_mash_em_can):
  ...
  data_driven_mats:       "/project2/mstephens/fmorgante/mr_mash_test/output/mvreg_all_genes_prior_GTExrealX_indepV_B_1causalrespr10_lowPVE_inter/prior/matrices/mvreg_all_genes_prior_GTExrealX_indepV_B_1causalrespr10_lowPVE.EZ.FL_PC3.rds"
