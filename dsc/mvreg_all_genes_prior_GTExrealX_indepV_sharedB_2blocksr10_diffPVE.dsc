...
indepV_sharedB_2blocksr_diffPVE: simulate_data_all_genes_prior_gtex_mod.R
  X:              $X
  p_causal:       5
  r:              10
  ...
  V_cor:          0
  testset_index:  "../output/mvreg_all_genes_prior_GTExrealX_indepV_sharedB_2blocksr10_diffPVE_inter/misc/testset_ids.rds"
  $Xtrain: out$Xtrain
  $Ytrain: out$Ytrain
  $Xtest:  out$Xtest
  $Ytest:  out$Ytest
...
mr_mash_em_data(mr_mash_em_can):
  ...
  data_driven_mats:       "/project2/mstephens/fmorgante/mr_mash_test/output/mvreg_all_genes_prior_GTExrealX_indepV_sharedB_2blocksr10_diffPVE_inter/prior/matrices/mvreg_all_genes_prior_GTExrealX_indepV_sharedB_2blocksr10_diffPVE.EZ.FL_PC3.rds"
